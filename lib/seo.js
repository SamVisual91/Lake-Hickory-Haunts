...
export const staticPageSeo = {
  home: {
    title: "Lake Hickory Haunts | Haunted Attraction in Hickory, NC",
    description:
      "Known as the Premier Haunt of the Carolinas, Lake Hickory Haunts is North Carolina's best haunted house attraction and theme park, featuring 13 unique haunted attractions for the price of one.",
    path: "/",
  },
  aboutUs: {
  ...
  tickets: {
    ...
    description:
      "Buy Lake Hickory Haunts tickets online. Online tickets start at $32 plus tax for General Admission, $48 for Fast Pass, and $66 for VIP; prices vary by date.",
    path: "/tickets",
  },
  whileYouWait: {
